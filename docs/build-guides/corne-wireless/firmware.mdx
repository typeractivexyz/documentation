...
The firmware files provided above are compatible with ZMK Studio. You can use the firmware files to flash your Corne Wireless and then use ZMK Studio to customize your keymap.
